...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/05/13 14:00:04 by ssalorin          #+#    #+#             */
/*   Updated: 2024/06/08 14:14:36 by ssalorin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*get_next_line(int fd)
{
	...
	if (!buffer)
		return (ft_free(&remainder));
	if (!ft_read_to_remainder(&remainder, fd, buffer))
		return (NULL);
	free(buffer);
	return (ft_make_line(&remainder));
}
